...
<div class="project-list">
  ...
  <div class="project">
    <div class="project-meta">
      <span class="project-tag">Glass · Simulations</span>
...
<img class="project-img" src="research/glass-transition.mp4" alt="Glass transition simulation">
  ...
  <div class="project">
    <div class="project-meta">
      <span class="project-tag">Active Matter · Soft Matter</span>
      <span class="project-status">Internship · 2025</span>
    </div>
    ...
    <p style="font-size:13px; color:var(--fg-muted); margin-top:6px;">
...
<img class="project-img" src="research/active-gel.jpg" alt="Active gel model">
  ...
  <div class="project">
    <div class="project-meta">
      <span class="project-tag">Biophysics · Nonlinear Dynamics</span>
      <span class="project-status">Internship · 2025</span>
    </div>
...
<img class="project-img" src="research/excitations-lfs.jpg" alt="Excitations and LFS">
  ...
  <div class="project">
    <div class="project-meta">
      <span class="project-tag">Glass · Statistical Mechanics</span>
      <span class="project-status">Published</span>
    </div>
...
<img class="project-img" src="research/nvu-polydisperse.jpg" alt="NVU polydisperse LJ">
  ...
  <div class="project">
    <div class="project-meta">
      <span class="project-tag">Proteins · Topology</span>
      <span class="project-status">Published</span>
    </div>
...
<div class="notes-list">
  <div class="note-item">
    ...
    <span class="note-desc">P.W. Anderson · More is Different</span>
  </div>
  <div class="note-item">
    <a class="note-title" href="topology_mix/">Topology 杂谈</a>
    <span class="note-desc">Miscellaneous musings</span>
  </div>
</div>
</section>
...
<!-- ═══════════════════════════════════════════
     ...
     Copy a <div class="pub-item">…</div> block to add more papers.
     ═══════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════
     ...
     Copy a <div class="talk-item">…</div> block to add more entries.
     ═══════════════════════════════════════════ -->
<section id="talks">
<p class="section-label">Conferences &amp; Talks</p>
<div class="talk-list">
...
<div class="contact-grid">
  ...
  <div class="contact-item">
    ...
    <div class="contact-value" style="font-size:14px; line-height:1.6;">
      10 rue Vauquelin,<br>
      75005 Paris,<br>
      France
    </div>
